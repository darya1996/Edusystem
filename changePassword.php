...
<li class="active">Change Password</li>
 ...
 <section class="content">
        <div class="col-xs-12">
  <div class="col-lg-4 col-sm-6 col-xs-12 no-padding"><h3 class="box-title"> Change User Password</h3></div>
</div>

<div class="col-xs-12 col-lg-12">
  <div class="box-info box view-item col-xs-12 col-lg-12">
    <div class="form">
	<form id="change-password-form" action="change_pswd.php" method="get" onsubmit="return false;">
