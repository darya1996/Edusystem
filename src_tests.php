...
<div class="col-xs-12 col-lg-12">
 ...
 include_once("php_includes/db_conx.php");
    $userData = mysqli_query($db_conx,"select * from tests where category_id=$id");
    while($row = mysqli_fetch_assoc($userData)){
        echo "<div class='test'>";
        echo "<div class='test-name'><a href='questions_test.php?id=".$row['test_id']."'>".$row['test_name']."</a></div>".
        "<div class='test-descr'>".$row['test_description']."</div></div>";
     }
 ?>
 </div>
