...
<!-- SQL query goes here -->
<?php 
$strSQL = "SELECT firstname, lastname, username, email FROM student WHERE username = '".$id."'";
...
?>
    ...
    <section class="content">
        <div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title">Profile</h3></div>
</div>
...
<label class="control-label" for="stuinfo-stu_gender">Email</label><input type="text" id="stuinfo-stu_mother_name" class="form-control" name="gender" value="<?php echo $email; ?>" readonly><div class="help-block"></div>
</div>    </div>
   </div>
 </div>
 </section>                
